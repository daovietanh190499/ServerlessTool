...
urlpatterns = [
    ...
    path('tools/<slug:slug>/env-vars/add/', views.add_env_var, name='add_env_var'),
    path('tools/<slug:slug>/env-vars/<int:env_id>/edit/', views.edit_env_var, name='edit_env_var'),
    path('tools/<slug:slug>/env-vars/<int:env_id>/delete/', views.delete_env_var, name='delete_env_var'),
